...
def analyze_resume_role(resume_text, job_role, company_name=None, extra_sections=None):
    """
    Analyzes the resume specifically against a target Job Role and optional Company.
    """
...
Your goal is to transform a user's Resume into a top-tier, 100/100 scored LinkedIn profile that perfectly aligns with a specific target role and company culture.
...
<task_description>
1.  **Analyze**: Deeply analyze the user's Resume against the Target Role and Company Guidelines. Identify gaps, weak language, and missing keywords.
